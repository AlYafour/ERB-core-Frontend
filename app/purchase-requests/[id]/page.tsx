...
export default function PurchaseRequestDetailPage() {
  ...
  const updateItemMutation = useMutation({
    ...
    onError: (e: unknown) => toast(getApiError(e, 'Failed to update product'), 'error'),
  });
  ...
  const addItemMutation = useMutation({
    ...
    onError: (e: unknown) => toast(getApiError(e, 'Failed to add product'), 'error'),
  });
  ...
  const deleteItemMutation = useMutation({
    ...
    onError: (e: unknown) => toast(getApiError(e, 'Failed to remove product'), 'error'),
  });
  ...
  const allowAdditionalOrderMutation = useMutation({
    ...
    onError: (e: unknown) => toast(getApiError(e, 'Failed to unlock additional order'), 'error'),
  });
