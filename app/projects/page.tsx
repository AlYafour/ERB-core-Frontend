...
export default function ProjectsPage() {
  const { page, setPage, search, handleSearch, selectedItems, toggleSelect, selectPage, clearSelection, isAllPageSelected, isSomePageSelected } = useTableState();
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        ...
        <TextField placeholder="Search projects..." value={search} onChange={e => handleSearch(e.target.value)} />
