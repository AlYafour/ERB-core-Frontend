      ...
      >
        ...
        {count > 0 && (
          <span className="absolute -top-0.5 -right-0.5">
            <span
              className="animate-notif-ping absolute inline-flex h-full w-full rounded-full"
              style={{ backgroundColor: 'var(--status-error-bg)', opacity: 0.6 }}
            />
            <span
              className="relative flex h-4 w-4 items-center justify-center rounded-full text-[10px] font-semibold"
