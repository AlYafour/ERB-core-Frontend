...
// Self-contained account-security widget: password, 2FA and passkeys. It owns
// its own data + state and renders no page chrome, so it can be mounted inside
// the employee profile OR on the standalone /security route — one source, no
// duplication.
