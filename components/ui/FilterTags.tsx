    ...
    <div className="flex flex-wrap items-center gap-2 mb-4">
      {tags.map((tag) => (
        <span
          ...
          style={{ backgroundColor: 'var(--color-wine-50)', color: 'var(--color-wine-500)', borderColor: 'rgba(201,148,58,0.22)' }}
        >
          {tag.label}
          <button
            onClick={() => {
            ...
            className="rounded-full p-0.5 transition-colors ml-0.5" style={{ '--tw-hover-bg': 'rgba(201,148,58,0.15)' } as any}
            onMouseEnter={e => (e.currentTarget.style.backgroundColor = 'rgba(201,148,58,0.15)')}
